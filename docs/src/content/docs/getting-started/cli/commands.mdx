...
- `--best` — save the best available image (the default)
- `--full` — require the original-resolution image
...
copy; otherwise the default media command may save only the thumbnail.
